...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Listagem de Livros</h1><table id=\"livros\"><tr><td>ID</td><td>Título</td><td>Preco</td><td>Editar</td><td>Remover</td></tr>");
  ...
  out.w("</table><script type=\"text/javascript\" src=\"/estatico/js/remove-livro.js\"></script>");
